...
`X0-Framework/.x0/agents/` (приватный фреймворк Сергея). Скопировано 2026-05-03,
консолидировано и адаптировано для модуля M4 курса HSS AI-Driven Development L1.
